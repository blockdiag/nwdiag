...
class TestRstDirectives(unittest2.TestCase):
    ...
    def test_base_with_block(self):
        ...
        doctree = publish_doctree(text)
        self.assertEqual(1, len(doctree))
        self.assertEqual(directives.packetdiag, type(doctree[0]))
    ...
    def test_desctable_with_rest_markups(self, path):
        ...
        self.assertEqual('1', tbody[0][0][0][0])
        self.assertEqual('server', tbody[0][1][0][0])
        self.assertEqual(4, len(tbody[0][2][0]))
        self.assertEqual(nodes.Text, type(tbody[0][2][0][0]))
        self.assertEqual('foo ', str(tbody[0][2][0][0]))
        self.assertEqual(nodes.emphasis, type(tbody[0][2][0][1]))
        self.assertEqual(nodes.Text, type(tbody[0][2][0][1][0]))
        self.assertEqual('bar', tbody[0][2][0][1][0])
        self.assertEqual(nodes.Text, type(tbody[0][2][0][2]))
        self.assertEqual(' ', str(tbody[0][2][0][2]))
        self.assertEqual(nodes.strong, type(tbody[0][2][0][3]))
        self.assertEqual(nodes.Text, type(tbody[0][2][0][3][0]))
        self.assertEqual('baz', str(tbody[0][2][0][3][0]))

        self.assertEqual('2', tbody[1][0][0][0])
        self.assertEqual('database', tbody[1][1][0][0])
        self.assertEqual(4, len(tbody[1][2][0]))
        self.assertEqual(nodes.strong, type(tbody[1][2][0][0]))
        self.assertEqual(nodes.Text, type(tbody[1][2][0][0][0]))
        self.assertEqual('foo', str(tbody[1][2][0][0][0]))
        self.assertEqual(nodes.Text, type(tbody[1][2][0][1]))
        self.assertEqual(' ', str(tbody[1][2][0][1]))
        self.assertEqual(nodes.emphasis, type(tbody[1][2][0][2]))
        self.assertEqual(nodes.Text, type(tbody[1][2][0][2][0]))
        self.assertEqual('bar', str(tbody[1][2][0][2][0]))
